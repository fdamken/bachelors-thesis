...
\newcommand{\hrefGithubKoopmanInference}[1]{\href{https://github.com/fdamken/bachelors-thesis_code/tree/submission}{#1}}
\newcommand{\hrefGithubVariationalKoopman}[1]{\href{https://github.com/fdamken/variational-koopman/tree/without-control}{#1}}

\includeonly{content/inference-in-dynamical-systems}
