...
\section{Koopman Theory of Dynamical Systems}
	...
	\end{equation*}
	and observations \( \vec{h} : \R^p \to \R^p \) of this system, \ac{ie} \( \vec{y}_t \coloneqq \vec{h}(\vec{x}_t) \), the infinite-dimensional \emph{Koopman operator} \(\mathcal{K}\) advances all of the measurements forward in time. This relation can also be expressed as the composition
	\begin{equation*}
