			...
			\begin{itemize}
				...
				\item<+-> "Classical" Linearization:
					\begin{itemize}
						...
						\item Diverge fast\dots
						\item Only provide a local model.
					\end{itemize}
				\item<+-> A global but easy model would be nice\dots
				\item<+-> Koopman theory offers exactly this: Easy (linear) and global models!
			\end{itemize}
		\end{frame}
		...
		\begin{frame}{Conclusion}
			\begin{itemize}
				...
				\item Results look promising for further research.
					\onslide<2->{
						\begin{itemize}
							\item Bayesian view on the dynamics.
							\item Automatic relevance determination; detect how many latent dimensions are needed.
						\end{itemize}
					}
			\end{itemize}
		\end{frame}
